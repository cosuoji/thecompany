...
const Footer = ({ navLinks = [] }) => {
  ...
  return (
    <footer className="bg-beige pt-12 px-5 md:px-10 lg:px-20 border-t border-gray-200">
        ...
        <div className="flex items-center gap-6">
          <h3 className="font-medium text-3xl text-black whitespace-nowrap">44</h3>
          <AnalogClock timezoneOffset={0} />
          <div className="text-sm leading-relaxed text-black ml-4">
        ...
        {/* Lagos */}
        <div className="flex items-center gap-6">
          <h3 className="font-medium text-3xl text-black whitespace-nowrap">234</h3>
          <AnalogClock timezoneOffset={0} />
          <div className="text-sm leading-relaxed text-black ml-4">
            <p>123 Madison Avenue</p>
            <p>New York, NY 10016</p>
      ...
      <div className="flex flex-col border-t border-gray-200 pt-6 md:flex-row justify-center items-center gap-12 mb-12">
        ...
        <div className="w-full max-w-md text-center">
          <h3 className="font-medium text-lg text-black mb-4 text-center">JOIN OUR NEWSLETTER</h3>

          {state.succeeded ? (
            <p className="text-black">Thanks for Subscribing to Our Newsletter</p>
          ) : (
            <form className="flex w-full" onSubmit={(e) => {
              ...
              <input
                ...
                id='email'
                name='email'
                className="flex-1 px-4 py-2.5 border-1 text-black text-sm focus:outline-none"
                required
              />
              <button
                disabled={state.submitting}
                type="submit"
                className="px-5 py-2.5 bg-black text-white text-sm hover:bg-black transition-colors rounded-shadow"
              >
  ...
  <h3 className="font-medium text-lg mb-4 text-black">FOLLOW US</h3>
  <div className="flex justify-center gap-4">
    {/* Twitter/X */}
    <a href="#" className="opacity-80 hover:opacity-100 transition-opacity text-black">
  ...
  <ul className="flex flex-wrap justify-center gap-6 text-sm text-black">
    {footerLinks.map((item) => (
      ...
      <div className="pt-8 border-t border-gray-200 text-center pb-6">
        <Link to="/"><div className="text-2xl text-black font-semibold tracking-wide mb-2 text-chocolate">OLÚ THE MAKER</div></Link>
